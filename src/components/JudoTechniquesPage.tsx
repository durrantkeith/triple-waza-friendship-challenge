...
export default function JudoTechniquesPage() {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-light text-slate-900 mb-6 tracking-tight">
            {pageData?.title || 'Judo Techniques'}
          </h1>

          <p className="text-lg text-slate-700 leading-relaxed font-light max-w-2xl mx-auto">
            {pageData?.description || 'Master the fundamental and advanced techniques of judo kata'}
          </p>
        </div>
        ...
        {sections.length === 0 && (
          <div className="text-center py-16 bg-white border border-slate-200">
            <BookOpen size={48} className="text-slate-300 mx-auto mb-4" strokeWidth={1.5} />
