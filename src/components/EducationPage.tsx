                      ...
                      <div className="relative w-full h-full">
                        ...
                        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center gap-4">
                          <button
                            ...
                            className="bg-red-600 hover:bg-red-700 rounded-full p-5 transition-all duration-300 hover:scale-110 shadow-2xl"
                            aria-label="Play video"
                          >
                            <Play className="w-14 h-14 text-white fill-white" />
                          </button>
                          <span className="text-white font-semibold">Click to play embedded video</span>
                        </div>
                      </div>
                    ) : (
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      {videoId && (
                        <a
                          ...
                          className="flex items-center gap-1 text-red-600 hover:text-red-700 text-sm font-semibold whitespace-nowrap ml-2"
                        >
                          <Play size={14} />
                          <span>YouTube</span>
                        </a>
