        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center mb-6">
            <div className="p-4 bg-amber-100 rounded-full">
              <Lightbulb className="text-amber-700" size={40} strokeWidth={1.5} />
            </div>
          </div>

          <h1 className="text-4xl md:text-5xl font-light text-slate-900 mb-6 tracking-tight">
            {pageData?.title || 'Training Tips'}
          </h1>

          <p className="text-lg text-slate-700 leading-relaxed font-light max-w-2xl mx-auto">
            {pageData?.description || 'Enhance your practice with expert guidance and proven methods'}
          </p>
        </div>
